...
<div class="small_close"> 
	<a href="javascript:$('#kor${korTermId}').unblock();$.unblockUI();"><img src="<c:url value="/images/term/close_small.png"/>" id="cancle"></a>
</div>
<div class="pop_input">
	<div class="title">한글용어 댓글</div>
...
function addComment(){
	...
	$.post(getUrl(${termId} + '/kor/' + ${korTermId} + '/comment/addsubmit'), param,
        function(data, status){
            if(status === "success" && data.result === 'success'){
                $('#subcontents').load(getUrl(${termId}) + ' ' + '#subcontents', function(){
                    loadKorTermDaumSearch();
                });
                $('#kor${korTermId}').unblock();$.unblockUI();
