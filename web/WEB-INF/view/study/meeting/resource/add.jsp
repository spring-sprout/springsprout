...
<page:popuppage>
	<form:form commandName="resource" method="post" action="/study/${studyId}/meeting/${meetingId}/resource/url/add">
	<p>
		<label>참고자료 타입</label>
...
$(document).ready( function(){
	...
	var fileUrl = "/study/${studyId}/meeting/${meetingId}/resource/file/add";
    ...
    $("#resourceType").change(function () {
		...
		if(str === '20'){
			...
			$("form").attr("action", '<c:url value="/study/${studyId}/meeting/${meetingId}/resource/file/add"/>');
			...
			$("form").attr("action", '<c:url value="/study/${studyId}/meeting/${meetingId}/resource/url/add"/>');
