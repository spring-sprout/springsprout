...
<s2c:module name="List of Surbey Post">
	<s2c:portlet target="${surbeyPostList}">
		<div id="post-list">
		<c:forEach items="${surbeyPostList}" var="post">
...
$(function(){ 
	...
	$('#writeBtn').click( function(e){
		$actionArea.load('${study.id}/post/surbeyPost');
	});
	...
	$('.post-text-title').click( function(event){
		...
		$actionArea.load('${study.id}/post/surbeyPost/' + postId + '?page=${pagingInfo.now}');
		return false;
	});	
